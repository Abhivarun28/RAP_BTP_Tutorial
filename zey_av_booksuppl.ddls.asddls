...
define view entity ZEY_AV_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZEY_AV_BOOKING as _Booking on
   $projection.BookingId = _Booking.BookingId and
   $projection.TravelId = _Booking.TravelId
association[1..1] to ZEY_AV_TRAVEL as _Travel on
