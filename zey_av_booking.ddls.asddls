...
define view entity ZEY_AV_BOOKING as select from /dmo/booking_m
composition[0..*] of ZEY_AV_BOOKSUPPL as _BookingSupplement
association to parent ZEY_AV_TRAVEL as _Travel on
